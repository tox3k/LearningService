(() => {
    ...
    const questions = [ {
        question: "Вопрос 1: Какой ваш любимый цвет?",
        options: [ "Красный", "Желтый" ]
    }, {
        question: "Вопрос 2: Что вы предпочитаете: кофе или чай?",
        options: [ "Кофе", "Чай" ]
    }, {
        question: "Вопрос 3: Какое ваше любимое время года?",
        options: [ "Весна", "Лето", "Осень", "Зима" ]
    }, {
        question: "Вопрос 4: Какую кухню вы предпочитаете?",
        options: [ "Итальянская", "Японская", "Французская", "Индийская" ]
    }, {
        question: "Вопрос 5: Какую музыку вы предпочитаете?",
        options: [ "Рок", "Поп", "Джаз", "Классика" ]
    }, {
        question: "Вопрос 6: Ваше любимое место отдыха?",
        options: [ "Пляж", "Горы", "Город", "Сельская местность" ]
    } ];
    function showQuestion(index) {
        const questionContainer = document.querySelector(".test__text");
        const optionsContainer = document.querySelector(".test__answers");
        const currentQuestion = questions[index];
        if (currentQuestion) {
            questionContainer.innerHTML = `<div>${currentQuestion.question}</div>`;
            ...
            questionContainer.innerHTML = "<p>Тест завершен!</p>";
            optionsContainer.innerHTML = "";
